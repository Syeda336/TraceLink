										...
										child: SingleChildScrollView(
											...
											child: Column(
												...
												children: [
																...
																children: [
																	IntrinsicWidth(
																		child: IntrinsicHeight(
																			...
																			//CHANGE HERE 
																			 Stack(
																				alignment: Alignment.center, // This centers the crown on the circle
																				children: [
																				// The CIRCLE (now first, so it's in the back)
																				Container(
																					decoration: BoxDecoration(
																					borderRadius: BorderRadius.circular(127), // Cleaner border radius
													...
													IntrinsicHeight(
														child: Container(
															margin: const EdgeInsets.only( bottom: 33, left: 23, right: 23),
															width: double.infinity,
															child: Column(
																crossAxisAlignment: CrossAxisAlignment.start,
																children: [
																										...
																										IntrinsicWidth(
																											child: IntrinsicHeight(
																												child: Column(
																													...
																													children: [
																														Container(
																															margin: const EdgeInsets.only( bottom: 1, right: 15),
																															child: Text(
																																"92%",
																																style: TextStyle(
																																	color: Color(0xFF101727),
																						...
																						child: IntrinsicHeight(
																							child: Container(
																								...
																								child: Row(
																									...
																									children: [
																										Container(
																											margin: const EdgeInsets.only( top: 25, bottom: 25, right: 12),
																											width: 45,
																											height: 47,
																											child: Image.network(
                                        ...
                                        MaterialPageRoute(builder: (context) => const AdminDashboard1LostItems()), 
														...
														child: IntrinsicHeight(
															child: Container(
																...
																margin: const EdgeInsets.only( bottom: 24, left: 23, right: 23),
																width: double.infinity,
																child: Column(
																	children: [
																		Text(
													...
													Align(
														alignment: Alignment(0.5, 0.0), // <-- Now this aligns relative to the screen
														child: Text(
