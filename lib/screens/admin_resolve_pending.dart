...
class AdminDashboardResolvePendingUserReport extends StatefulWidget {
  ...
  @override
  AdminDashboardResolvePendingUserReportState createState() =>
      AdminDashboardResolvePendingUserReportState();
}

class AdminDashboardResolvePendingUserReportState
    extends State<AdminDashboardResolvePendingUserReport> {
  String textField1 = '';
  @override
                                                    ...
                                                    child: InkWell(
                                                      onTap: () {
                                                        Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                            builder: (context) =>
                                                                const AdminDashboardAfterWarningUser(),
                                                          ),
                                                        );
                                                      },
                                                      child: IntrinsicHeight(
