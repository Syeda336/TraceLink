...
class AdminDashboardAfterWarningUser extends StatefulWidget {
	...
	@override
		AdminDashboardAfterWarningUserState createState() => AdminDashboardAfterWarningUserState();
	}
class AdminDashboardAfterWarningUserState extends State<AdminDashboardAfterWarningUser> {
	@override
												...
												children: [
													...
													IntrinsicHeight(
														child: Container(
															...
															margin: const EdgeInsets.only( bottom: 25, left: 23, right: 48),
															width: double.infinity,
															child: Row(
																crossAxisAlignment: CrossAxisAlignment.start,
																children: [
                                  ...
                                  //*****GO TO CLAIMS PAGE  */
													...
													IntrinsicHeight(
														child: Container(
															...
															margin: const EdgeInsets.only( bottom: 17, left: 23, right: 48),
															width: double.infinity,
															child: Row(
																children: [
																	Container(
													...
													IntrinsicHeight(
														child: Container(
															...
															margin: const EdgeInsets.only( bottom: 14, left: 23, right: 48),
															width: double.infinity,
															child: Column(
																crossAxisAlignment: CrossAxisAlignment.start,
																children: [
													...
													IntrinsicHeight(
														child: Container(
															...
															margin: const EdgeInsets.only( bottom: 103, left: 24, right: 47),
															width: double.infinity,
															child: Column(
																crossAxisAlignment: CrossAxisAlignment.start,
																children: [
																	IntrinsicHeight(
																		child: Container(
																			...
																			margin: const EdgeInsets.only( top: 15, bottom: 21),
																			width: double.infinity,
																			child: Column(
																				crossAxisAlignment: CrossAxisAlignment.start,
																				children: [
