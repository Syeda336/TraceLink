...
class _PrivacySecurityScreenState extends State<PrivacySecurityScreen> {
  ...
  // Removed _profileVisibility = true;
...
void _handleSwitchChange(String settingName, bool newValue) async {
  setState(() {
    ...
    // Removed: if (settingName == 'Profile Visibility') { _profileVisibility = newValue; } else 
    if (settingName == 'Show Email') {
      _showEmail = newValue;
  ...
  bool success = await FirebaseService.updatePrivacySettings(
    ...
    profileVisibility: false, // Defaulting to false as it's no longer a user-set option
...
Future<void> _loadPrivacySettings() async {
  ...
  if (privacySettings != null) {
    setState(() {
      // Removed: _profileVisibility = privacySettings['profileVisibility'] ?? true;
      ...
      child: Row(
        children: [
          ...
          Switch(
            value: value,
            onChanged: onChanged,
            activeThumbColor: _brightBlue, // Bright blue active color
            activeTrackColor: _darkBlue, // Dark blue thumb color
          ),
        ],
      ),
    );
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                _buildSection(
                  ...
                  children: [
                    // Removed Profile Visibility switch
                    // Show Email
                    _buildSwitchRow(
                      icon: Icons.public,
                      iconColor:
